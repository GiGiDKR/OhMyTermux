...
```bash
curl -sL https://raw.githubusercontent.com/GiGiDKR/OhMyTermux/1.0.0/install-FR.sh -o install.sh && chmod +x install.sh && ./install.sh
```
...
```bash
curl -sL https://raw.githubusercontent.com/GiGiDKR/OhMyTermux/1.0.0/install-FR.sh -o install.sh && chmod +x install.sh && ./install.sh --gum
```
